...
<meta name="description" content="用心去聆听这个世界的声音|天虎娱乐网FM音乐">
<meta name="keywords" content="云上的日子FM,云上的日子FM音乐电台,云上的日子--FM电台,云上的日子电台,云上的日子音乐电台,云上的日子,在线FM音乐电台,网易云外链网站"/>
    <title>FM音乐电台|强大的网易云外链|歌曲下载系统|外链获取工具</title>
...
<body>
    ...
    <div style="height:354px; background-image: url(http://cn.bing.com/az/hprichbg/rb/GroundNest_ZH-CN8953105132_1920x1080.jpg); background-repeat:no-repeat;background-attachment:fixed;">
        <div class="animated fadeInDown">
            <div class="nav">
                <a href="https://ods.im/music" target="_blank">在线音乐</a>
                &nbsp;&nbsp;/&nbsp;&nbsp;
                <a href="https://ods.im/fm" target="_blank">FM音乐电台</a>
                &nbsp;&nbsp;/&nbsp;&nbsp;
                <a href="https://pay.ods.im/" target="_blank">赞助网站</a>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            </div>
            ...
            <div style="width:100%; text-align:center; position:relative;top:80px">
				...
				<input type="text" onkeyup="ss()" id="txtSong" placeholder="请输入歌曲名称，例如： 蔡依林 成都 ..." />
    ...
    <div>
        ...
        <div style="color:black; font-family:微软雅黑; font-size:14px; position:relative; top:80px;text-align:center">
            &copy; 2017-2018 本站仅供交流学习使用 所有法律责任概不负责
        </div>
    </div>
