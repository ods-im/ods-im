...
var mp3Url = "http://music.163.com/song/media/outer/url?id="+SongJson.result.songs[i].id+".mp3";//获取音乐链接
...
$(".datatable").addClass("animated fadeInDown");
	...
	if (localStorage["PlayerList"] == "" || localStorage["PlayerList"] == null || localStorage["PlayerList"] == undefined) {
		t = {
			playlist: [{
				file: "http://music.163.com/song/media/outer/url?id=32450986.mp3",
				thumb: "http://p1.music.126.net/iAaRt_l_ussYqkLVuDEpqg==/2931298001578529.jpg",
				trackName: "走在冷风中",
				trackArtist: "周二珂",
				trackAlbum: "走在冷风中"
			}, {
				file: "http://music.163.com/song/media/outer/url?id=1345848098.mp3",
				thumb: "http://p2.music.126.net/R4ZP3AJ9xV0vvw8LX7AbMA==/109951163860425334.jpg",
				trackName: "绿色",
				trackArtist: "陈雪凝",
				trackAlbum: "绿色"
			}],
