...
<div class="container">
  ...
  <!-- 左侧布局 -->
  <div class="left-nav">
    <button type="button" class="btn btn-dark">活动码管理</button>
    <button type="button" class="btn btn-light" data-toggle="modal" data-target="#addactive_modal">创建活动</button>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <!-- 提交 -->
          <button type="button" class="btn btn-dark" onclick="gethtmlcontent();addactive();">立即创建</button>
          </form>
